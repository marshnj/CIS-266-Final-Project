...
# Create the window for the Account Request form
window = tkinter.Tk()
...
# Row 00 - Request an Account Screen Window label
...
# Row 03 - First Name label and entry field
...
# Row 05 - Last Name label and entry field
...
# Row 07 - Show/Hide Password checkbutton
...
# Row 08: Request account commit button
